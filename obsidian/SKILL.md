---
name: obsidian-sync
description: Sync coding project context into an Obsidian vault using Johnny Decimal conventions, including project file creation/updates, dev logs, stack metadata, architecture canvases, and vault map updates. Use when asked to sync a codebase with Obsidian project notes or maintain Obsidian project tracking artifacts.
---

# Obsidian Sync

Bridge between Coding Agent sessions and your Obsidian vault. Syncs codebase state, dev logs, and architecture diagrams into the vault's Johnny Decimal structure.
